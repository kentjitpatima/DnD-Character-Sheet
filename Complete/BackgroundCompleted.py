...
print "Pick a trait from below" + "\n"
for i in range(1,9):
    print str(i) + " : " + eval(player_background[0].lower() + "_trait")[i]
def choose_trait():
    while True:
        print
        trait_input = raw_input("Enter R for RANDOM, the number of your desired ideal, or NONE to write your own: ").upper()
        if trait_input == "1" or trait_input == "2" or trait_input == "3" or trait_input == "4" or trait_input == "5" or trait_input == "6" or trait_input == "7" or trait_input == "8":
            player_trait.append(eval(player_background[0].lower()+ "_trait")[int(trait_input)])
            print '\n' +  "Your trait is now: %s" % player_trait[0] + '\n'+ '\n'
            return True
            ...
            x = randint(1,6)
            player_trait.append(eval(player_background[0].lower()+ "_trait")[x])
            print
            print
            print '\n' +  "Your trait is now: %s" % player_trait[0]
            print
            ...
            print
choose_trait()
print "Pick a ideal from below" + "\n"
for i in range(1,7):
    print str(i) + " : " + eval(player_background[0].lower() + "_ideal")[i]
def choose_ideal():
    while True:
        print
        ...
        if ideal_input == "1" or ideal_input == "2" or ideal_input == "3" or ideal_input == "4" or ideal_input == "5" or ideal_input == "6":
            player_ideal.append(eval(player_background[0].lower()+ "_ideal")[int(ideal_input)])
            print '\n' +  "Your ideal is now: %s" % player_ideal[0] + '\n'+ '\n'
            return True
            ...
            x = randint(1,6)
            player_ideal.append(eval(player_background[0].lower()+ "_ideal")[x])
            print
            print
            print '\n' +  "Your ideal is now: %s" % player_ideal[0]
            print
...
print "Pick a bond from below" + "\n"
for i in range(1,7):
    print str(i) + " : " + eval(player_background[0].lower() + "_bond")[i]
def choose_bond():
    while True:
        print
        ...
        if bond_input == "1" or bond_input == "2" or bond_input == "3" or bond_input == "4" or bond_input == "5" or bond_input == "6":
            player_bond.append(eval(player_background[0].lower()+ "_bond")[int(bond_input)])
            print '\n' +  "Your bond is now: %s" % player_bond[0] + '\n'+ '\n'
            return True
            ...
            x = randint(1,6)
            player_bond.append(eval(player_background[0].lower()+ "_bond")[x])
            print
            print
            print '\n' +  "Your bond is now: %s" % player_bond[0]
            print
...
print "Pick a flaw from below" + "\n"
for i in range(1,7):
    print str(i) + " : " + eval(player_background[0].lower() + "_flaw")[i]
def choose_flaw():
    while True:
        print
        ...
        if flaw_input == "1" or flaw_input == "2" or flaw_input == "3" or flaw_input == "4" or flaw_input == "5" or flaw_input == "6":
            player_flaw.append(eval(player_background[0].lower()+ "_flaw")[int(flaw_input)])
            print '\n' +  "Your flaw is now: %s" % player_flaw[0] + '\n'+ '\n'
            return True
            ...
            x = randint(1,6)
            player_flaw.append(eval(player_background[0].lower()+ "_flaw")[x])
            print
            print
            print '\n' +  "Your flaw is now: %s" % player_flaw[0]
            print
